...
public class MainActivity extends AppCompatActivity {
    EditText nomb, desc;
    Button btnSalvar, btnFoto, btnLista;
    ImageView imagen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        btnSalvar.setOnClickListener(this::onClickGuardar);
    ...
    private void onClickListActivity(View view) {
        Intent lista = new Intent(getApplicationContext(), com.example.ejercicio14.ActivityLista.class);
        startActivity(lista);
    }
    ...
    private void takePhoto() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            try {
                ...
                if (photoFile != null) {
                    Uri photoURI = FileProvider.getUriForFile(this, "com.example.ejercicio14.fileprovider", photoFile);
